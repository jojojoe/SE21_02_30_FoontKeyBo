...
class FKbCoinMana: NSObject {
    ...
    static var AppGroup = "group.com.superegg.okeydokey"
//    static var AppGroup = "group.com.keyinsfont.superone"
    ...
    func isFirstSendCoin() -> Bool {
        guard let userDefault = UserDefaults.init(suiteName: FKbCoinMana.AppGroup) else {
            return true
        }
        
        if let coinObj = userDefault.object(forKey: FKbCoinMana.kUserDefaultsCoinCount) {
            return false
        } else {
            return true
        }
    ...
    func loadDefaultData() {
        ...
        #if DEBUG // 如果有keychain的 话  group无法存金币信息 group删掉以后 无法保留
//        KeychainSaveManager.removeKeychainCoins()
        #endif
        // KeychainSaveManager.isFirstSendCoin()
        if isFirstSendCoin() {
            coinCount = coinFirst
...
//            coinCount = KeychainSaveManager.readCoinFromKeychain()
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.keyinsfont.superone.listone", coin: 100, price: "$0.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.keyinsfont.superone.listtwo", coin: 300, price: "$1.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.keyinsfont.superone.listthree", coin: 600, price: "$3.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.keyinsfont.superone.listfour", coin: 1000, price: "$5.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.keyinsfont.superone.listfive", coin: 1500, price: "$9.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.keyinsfont.superone.listsix", coin: 2500, price: "$11.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.keyinsfont.superone.listseven", coin: 4000, price: "$15.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.keyinsfont.superone.listeight", coin: 6000, price: "$18.99", color: "#C9FFEE")
